...
python3 train_student.py --path_t '/home/patrick/Desktop/CID/save/models/wrn_40_4_vanilla_cifar100/ckpt_epoch_240.pth' --dataset cifar100 --model_s wrn_16_2 -NT 4 -a 1 -b 55 -c 0.1 --use_int 